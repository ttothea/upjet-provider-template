...
PROJECT_NAME ?= provider-azurerm
PROJECT_REPO ?= github.com/cps-az-provider/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-azurerm_v4.77.0_x5
...
xpkg.build.provider-azurerm: do.build.images
