...
PROJECT_NAME ?= provider-cps-managedpools
PROJECT_REPO ?= github.com/ttothea/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 4.78.0
...
xpkg.build.provider-cps-managedpools: do.build.images
