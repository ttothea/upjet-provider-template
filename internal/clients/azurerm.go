...
import (
	...
	clusterv1beta1 "github.com/cps-az-provider/provider-azurerm/apis/cluster/v1beta1"
	namespacedv1beta1 "github.com/cps-az-provider/provider-azurerm/apis/namespaced/v1beta1"
)
...
const (
	...
	errUnmarshalCredentials = "cannot unmarshal azurerm credentials as JSON"
)
